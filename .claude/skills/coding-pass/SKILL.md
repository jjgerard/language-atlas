---
name: coding-pass
description: Turn a language-atlas field's prose into the controlled-vocabulary columns defined in src/coding.js, then write them with research/tools/apply-coding.js and report the distribution. Use this whenever the work touches coding entries, applying or revising a coding, filling coding columns, making a field comparable or quantitative across countries, running apply-coding.js, or looking at how a coded column is distributed — including when the request just names a field ("code identificationCriteria", "let's do newcomerCriteria next", "can we get numbers out of legalEntitlement") without using the word coding at all.
---

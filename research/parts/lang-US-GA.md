...
EVIDENCE:
 ...
 - field: languages
   ...
   source: standing text on this entry
   note: ABSENCE IS THE RESULT, and it is a real one. Neither the entry's text nor either cited source names a single Indigenous or regional language of Georgia. No row can be written without inventing one, so none is.
DRAFT BULLETS:
 - field: localTerm
   bullets:

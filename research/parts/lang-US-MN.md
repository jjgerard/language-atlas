...
EVIDENCE:
 ...
 - field: languages
   ...
   source: standing text on this entry
 - field: languages
   quote: "Seal awarded in 23 languages 2022-23, none Native American or Pacific"
   source: standing text on this entry
 - field: languages
   quote: "Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages"
   source: standing text on this entry
   note: ABSENCE IS THE RESULT, and it is a real one. Neither the entry's text nor either cited source names a single Indigenous or regional language of Minnesota. No row can be written without inventing one, so none is.
DRAFT BULLETS:
 - field: localTerm
   bullets:

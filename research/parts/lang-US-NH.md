...
EVIDENCE:
 - field: languages
   quote: "Not found in the sources cited; New Hampshire statute itself was not examined"
   source: standing text on this entry
 - field: languages
   quote: "Sixteen Seal of Biliteracy languages in 2022-23, none of them Native American"
   source: standing text on this entry
 - field: languages
   quote: "ECS names Native American languages in the North Dakota row alone, of 51 units"
   source: standing text on this entry
 - field: languages
   quote: "New Hampshire's Seal list also omits American Sign Language, unlike most states"
   source: standing text on this entry
   note: ABSENCE IS THE RESULT, and it is a real one. Neither the entry's text nor either cited source names a single Indigenous or regional language of New Hampshire. No row can be written without inventing one, so none is.
DRAFT BULLETS:
 - field: localTerm
   bullets:

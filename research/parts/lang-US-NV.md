...
EVIDENCE:
 - field: languages
   quote: "Nevada did not report to the 2024 Seal survey, so its language list is unknown"
   source: standing text on this entry
 - field: languages
   quote: "Not found in the sources cited; Nevada statute itself was not examined"
   source: standing text on this entry
 - field: languages
   quote: "ECS names Native American languages in the North Dakota row alone, of 51 units"
   source: standing text on this entry
 - field: languages
   quote: "No Nevada entry in the Seal report's Native and Pacific Islander language table"
   source: standing text on this entry
   note: ABSENCE IS THE RESULT, and it is a real one. Neither the entry's text nor either cited source names a single Indigenous or regional language of Nevada. No row can be written without inventing one, so none is.
DRAFT BULLETS:
 - field: localTerm
   bullets:

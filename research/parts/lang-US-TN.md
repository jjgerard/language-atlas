...
EVIDENCE:
 - field: languages
   quote: "Tennessee statute not itself examined; this rests on the Seal report and ECS"
   source: standing text on this entry
 - field: languages
   quote: "Twenty-one Seal of Biliteracy languages in 2022-23, none Native American"
   source: standing text on this entry
 - field: languages
   quote: "Tennessee awards none of the 11 Native and Pacific Islander Seal languages"
   source: standing text on this entry
 - field: languages
   quote: "ECS names Native American languages in the North Dakota row alone, of 51 units"
   source: standing text on this entry
   note: ABSENCE IS THE RESULT, and it is a real one. Neither the entry's text nor either cited source names a single Indigenous or regional language of Tennessee. No row can be written without inventing one, so none is.
DRAFT BULLETS:
 - field: localTerm
   bullets:

...
EVIDENCE:
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Alaska.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement and courses are not required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Alaska.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement and courses are not required to be offered ( n  = 12) | Alaska, Arizona, Arkansas, Colorado, Florida, Kentucky, Massachusetts, Mississippi, Missouri, Montana, Utah, Vermont"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6. Alaska sits in the weakest of the six categories.
...
POLICY HISTORY (proposed rows):
 - {year: 2022, description: "Alaska adopts a State Seal of Biliteracy (6/8/2022); first awarded in school year 2023-2024"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Alaska: 134,315 K-12 population; 22,187 enrolled in foreign language; 16.52%
 - Alaska Stat. 44.12.310 as amended by enrolled HB 216 makes 20 Alaska Native languages official alongside English (https://www.akleg.gov/basis/Bill/Text/28?Hsid=HB0216Z, 200): "The English , Inupiaq, Siberian Yupik, Central Alaskan Yup'ik, Alutiiq, Unangax, Dena'ina, Deg Xinag, Holikachuk, Koyukon, Upper Kuskokwim, Gwich'in, Tanana, Upper Tanana, Tanacross, Han, Ahtna, Eyak, Tlingit, Haida, and Tsimshian languages are [LANGUAGE IS] the official languages [LANGUAGE] of the State of Alaska."
 - Yugtun and Yup'ik were awarded in the Alaska Seal of Biliteracy in 2022-23 (Seal Table 4) - relevant to regionalMinorityLanguages, which is not a gap field for Alaska

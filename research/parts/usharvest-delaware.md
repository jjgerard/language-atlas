...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Delaware is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Delaware.
 - field: fl.primaryRequirement
   quote: "Standard diploma requires credit or proficiency for graduation"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Delaware.
 - field: fl.primaryRequirement
   quote: "ensuring that all elementary school students have an opportunity to attend a school where all elementary school subjects, with the exception of foreign languages, are taught in the English language"
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: 14 Delaware Code 4145 (2022), as reproduced by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Delaware does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Akan (Fante/Asante/Twi), American Sign Language (ASL), Arabic, Chinese (Mandarin), French, German, Greek, Haitian Creole, Hindi, Italian, Latin, Portuguese, Romanian/Rumanian, Spanish, Thai, Turkic/Turkish/Uyhur, Ukrainian"
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Seal of Biliteracy Table 2, the complete list of 17 languages awarded in Delaware in SY2022-2023. No Native American or other Indigenous language of the United States appears in it.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Delaware's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - 14 Del. C. 4145 exempts foreign languages from the English-medium elementary rule
 ...
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 17 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2017, description: "Delaware adopts a State Seal of Biliteracy (7/21/2017); first awarded in school year 2017-2018"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Delaware: 149,108 K-12 population; 48,218 enrolled in foreign language; 32.34%

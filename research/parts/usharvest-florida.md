...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Florida is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement
   ...
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Florida is among them - the K-12 duty is unspecified as to grade, so it is not an elementary-specific rule.
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Florida.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement and courses are not required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Florida.
 - field: fl.primaryRequirement
   quote: "Core courses of mathematics, language arts, social studies, science, reading, and literature for grades K-12"
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: Florida Statutes 1003.02 and 1003.4156 (2022), as listed by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Florida does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   ...
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Florida reported award totals but no language list, so it is absent from Table 2. Its absence from Table 4 is still informative because Table 4 is drawn from the 35 states that did report.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Florida's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - Law requires world language be offered K-12 but names no grade level
...
POLICY HISTORY (proposed rows):
 - {year: 2016, description: "Florida adopts a State Seal of Biliteracy (4/14/2016); first awarded in school year 2016-2017"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Florida: 2,981,349 K-12 population; 622,451 enrolled in foreign language; 20.88%

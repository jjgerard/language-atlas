...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Georgia is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   quote: "Multiple options: 3 units chosen from CTAE, fine arts or modern language/Latin*"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 "Foreign Lang." column for Georgia.
 - field: fl.primaryRequirement
   quote: "Standard diploma includes world language as an option to fulfill a credit requirement"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Georgia.
 - field: fl.primaryRequirement
   quote: "History of the United States and the state of Georgia"
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: Georgia Code 20-2-142 to 20-2-149.3 (2021), as listed by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Georgia does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Akan (Fante/Asante/Twi), Chinese (Unspecified), Czech, English, French, German, Haitian Creole, Hindi, Japanese, Korean, Latin, Patois, Portuguese, Russian, Spanish, Tamil, Vietnamese"
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Seal of Biliteracy Table 2, the complete list of 17 languages awarded in Georgia in SY2022-2023. No Native American or other Indigenous language of the United States appears in it.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Georgia's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - Modern language or Latin is one of three optional units for a standard diploma
...
POLICY HISTORY (proposed rows):
 - {year: 2016, description: "Georgia adopts a State Seal of Biliteracy (5/3/2016); first awarded in school year 2016-2017"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Georgia: 1,832,631 K-12 population; 407,323 enrolled in foreign language; 22.23%

...
EVIDENCE:
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   quote: "Multiple options: 1 unit humanities, chosen from visual arts, music, theatre, dance, world language, literature, history, philosophy, architecture or comparative world religions"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 "Foreign Lang." column for Idaho.
 - field: fl.primaryRequirement
   quote: "Standard diploma includes world language as an option to fulfill a credit requirement"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Idaho.
 - field: fl.primaryRequirement
   quote: "The Constitution of the United States, the American flag, and citizenship"
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: Idaho Code 33-1602 and 33-1605 (2022), as listed by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Idaho does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Arabic, Chinese (Mandarin), French, Spanish"
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Seal of Biliteracy Table 2, the complete list of 4 languages awarded in Idaho in SY2022-2023. No Native American or other Indigenous language of the United States appears in it.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Idaho's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - World language is one of ten options for a single humanities graduation unit
 ...
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 4 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2020, description: "Idaho adopts a State Seal of Biliteracy (3/10/2020); first awarded in school year 2021-2022"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Idaho: 308,290 K-12 population; 37,584 enrolled in foreign language; 12.19%

...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Illinois is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   quote: "Multiple options: 1 unit chosen from art, music, foreign language or CTE"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 "Foreign Lang." column for Illinois.
 - field: fl.primaryRequirement
   quote: "Standard diploma requires credit or proficiency for graduation"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Illinois.
 - field: fl.primaryRequirement
   quote: "One year chosen from (A) music, (B) art, (C) foreign language, which shall be deemed to include American Sign Language, (D) vocational education, or (E) forensic speech (speech and debate)."
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: 105 Illinois Compiled Statutes 5/27-22, 'Required high school courses', as reproduced by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Illinois does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Table 2 lists the languages in which the SoBL was awarded in each state."
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Illinois reported 48 languages in Table 2; the full list was read and contains no Native American or other Indigenous language of the United States.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Illinois's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - 105 ILCS 5/27-22 counts American Sign Language as a foreign language
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 48 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2013, description: "Illinois adopts a State Seal of Biliteracy (8/27/2013); first awarded in school year 2014-2015"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Illinois: 2,258,315 K-12 population; 294,686 enrolled in foreign language; 13.05%

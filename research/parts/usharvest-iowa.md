...
EVIDENCE:
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Iowa.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement but courses are required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Iowa.
 - field: fl.primaryRequirement
   quote: "Four sequential units of one world language which may include American sign language."
   source: https://ballotpedia.org/K-12_areas_of_instruction_required_by_statute_in_the_states
   note: Iowa Code 256.11 (2022), as reproduced by Ballotpedia. Reproduced by Ballotpedia from the statute; the list names no foreign or world language at elementary level unless quoted otherwise above.
 - field: fl.regionalMinorityLanguages
   ...
   note: Iowa does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "American Sign Language (ASL), Amharic, Arabic, Bosnian, Burmese, Chinese (Unspecified), Danish, French, German, Hebrew, Hindi, Italian, Japanese, Korean, Latin, Romanian/Rumanian, Russian, Serbian, Spanish, Swahili, Swedish, Tamil, Telugu (Telegu), Turkic/Turkish/Uyghur, Ukrainian, Vietnamese"
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Seal of Biliteracy Table 2, the complete list of 26 languages awarded in Iowa in SY2022-2023. No Native American or other Indigenous language of the United States appears in it.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Iowa's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - No graduation requirement, but world language courses must be offered
     - Iowa Code 256.11 allows American Sign Language to count as a world language
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 26 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2018, description: "Iowa adopts a State Seal of Biliteracy (4/17/2018); first awarded in school year 2018-2019"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Iowa: 524,775 K-12 population; 79,944 enrolled in foreign language; 15.23%

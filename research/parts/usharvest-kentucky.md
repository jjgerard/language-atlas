...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Kentucky is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Kentucky.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement and courses are not required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Kentucky.
 - field: fl.regionalMinorityLanguages
   ...
   note: Kentucky does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Table 2 lists the languages in which the SoBL was awarded in each state."
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Kentucky reported 34 languages in Table 2; the full list was read and contains no Native American or other Indigenous language of the United States.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Kentucky's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 ...
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 34 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2021, description: "Kentucky adopts a State Seal of Biliteracy (4/1/2021); first awarded in school year 2021-2022"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Kentucky: 741,776 K-12 population; 83,098 enrolled in foreign language; 11.20%

...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Maryland is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement
   ...
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Maryland is among them - the requirement begins at middle school, not elementary.
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   quote: "Multiple options: 2 units chosen from world language or advanced technology education, or successful completion of a state-approved career and technology program"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 "Foreign Lang." column for Maryland.
 - field: fl.primaryRequirement
   quote: "Standard diploma includes world language as an option to fulfill a credit requirement"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Maryland.
 - field: fl.primaryRequirement
   quote: "For example, policy in the state of Maryland, school systems must provide world language \"beginning not later than middle learning years\" (Programs in World Languages, 2010). While this policy language may encourage elementary school programs, this is not an explicit requirement because the provision could be fulfilled without the elementary school classes."
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: The authors expressly considered and excluded Maryland from the elementary list.
 - field: fl.regionalMinorityLanguages
   ...
   note: Maryland does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   ...
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Maryland reported award totals but no language list, so it is absent from Table 2. Its absence from Table 4 is still informative because Table 4 is drawn from the 35 states that did report.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Maryland's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - Study calls the "not later than middle learning years" wording not a requirement
 - field: fl.regionalMinorityLanguages
   bullets:
...
POLICY HISTORY (proposed rows):
 - {year: 2016, description: "Maryland adopts a State Seal of Biliteracy (4/26/2016); first awarded in school year 2016-2017"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Maryland: 976,670 K-12 population; 344,072 enrolled in foreign language; 35.23%

...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Michigan is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   quote: "2 units same foreign language completed in any grades K-12****"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 "Foreign Lang." column for Michigan.
 - field: fl.primaryRequirement
   quote: "Standard diploma requires credit or proficiency for graduation"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Michigan.
 - field: fl.primaryRequirement
   quote: "2 units same foreign language completed in any grades K-12"
   source: https://reports.ecs.org/comparisons/high-school-graduation-requirements-01
   note: ECS 2019 Foreign Lang. column for Michigan. Credit may be earned in the elementary grades, but nothing requires elementary schools to teach a language.
 - field: fl.regionalMinorityLanguages
   ...
   note: Michigan does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "Table 2 lists the languages in which the SoBL was awarded in each state."
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Michigan reported 44 languages in Table 2; the full list was read and contains no Native American or other Indigenous language of the United States.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Michigan's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 - field: fl.primaryRequirement
   bullets:
     ...
     - ECS: 2 units of one language may be completed in any grades K-12
 - field: fl.regionalMinorityLanguages
   bullets:
...
POLICY HISTORY (proposed rows):
 - {year: 2018, description: "Michigan adopts a State Seal of Biliteracy (1/25/2018); first awarded in school year 2018-2019"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Michigan: 1,708,384 K-12 population; 384,442 enrolled in foreign language; 22.50%

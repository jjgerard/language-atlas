...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Minnesota is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Minnesota.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement but courses are required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Minnesota.
 - field: fl.regionalMinorityLanguages
   ...
   note: Minnesota does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   quote: "American Sign Language (ASL), Amharic, Arabic, Bulgarian, Chinese (Mandarin), Czech, French, German, Hebrew, Hindi, Hmong/Mong, Hungarian, Japanese, Karen/Karenni/Pwo, Korean, Oromo, Polish, Portuguese, Russian, Somali, Spanish, Tami, Vietnamese"
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Seal of Biliteracy Table 2, the complete list of 23 languages awarded in Minnesota in SY2022-2023. No Native American or other Indigenous language of the United States appears in it.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Minnesota's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
DRAFT BULLETS:
 ...
 - field: fl.regionalMinorityLanguages
   bullets:
     ...
     - Seal awarded in 23 languages 2022-23, none Native American or Pacific
     - Only AK, AZ, CA, HI, NM, OR, WA awarded Indigenous US languages
POLICY HISTORY (proposed rows):
 - {year: 2014, description: "Minnesota adopts a State Seal of Biliteracy (5/16/2014); first awarded in school year 2014-2015"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Minnesota: 928,080 K-12 population; 188,018 enrolled in foreign language; 20.26%

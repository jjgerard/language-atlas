...
EVIDENCE:
 - field: fl.primaryRequirement
   ...
   note: Mississippi is NOT among them.
 - field: fl.primaryRequirement
 ...
 - field: fl.primaryRequirement (high-school contrast, from the cited ECS comparison)
   ...
   note: ECS 2019 "Foreign Lang." column for Mississippi.
 - field: fl.primaryRequirement
   quote: "No world language graduation requirement and courses are not required to be offered"
   source: https://onlinelibrary.wiley.com/doi/10.1111/flan.70020?af=R
   note: Foreign Language Annals Table 6 category for Mississippi.
 - field: fl.regionalMinorityLanguages
   ...
   note: Mississippi does not appear anywhere in Table 4.
 - field: fl.regionalMinorityLanguages
   ...
   source: https://sealofbiliteracy.org/doc/2024-National-Seal-of-Biliteracy-Report-Final.pdf
   note: Mississippi therefore has no list of awarded languages in this report - a data gap, not a demonstrated absence of Indigenous-language awards.
...
50-state statute inventory, 68,034 chars):
 ...
 - The article inventories world language requirements in the statutes of all 50 states and DC and
   ...
   Combined with Mississippi's absence from Seal of Biliteracy Table 4, no provision for a language of the
...
POLICY HISTORY (proposed rows):
 - {year: 2019, description: "Mississippi adopts a State Seal of Biliteracy (10/10/2019); first awarded in school year 2020-2021"}
CONTEXT NOT REQUESTED (recorded because the document was open, do not overwrite existing fields):
 - American Councils 2017 Table 1, Mississippi: 544,498 K-12 population; 72,527 enrolled in foreign language; 13.32%
